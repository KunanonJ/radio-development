...
export function PlayerBar() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex flex-col pb-[env(safe-area-inset-bottom,0px)] surface-2 border-t border-border">
      <div className="flex items-center h-[var(--player-height)] px-2 sm:px-4 gap-2 sm:gap-4">
        {/* Track info */}
        ...
        {/* Playback controls */}
        <div className="flex-[2] min-w-0 flex flex-col items-center gap-1 max-w-[600px]">
        ...
        {/* Right controls */}
        <div className="flex items-center gap-2 sm:gap-3 shrink-0 md:w-[200px] justify-end">
          <Link
            to="/app/queue"
          ...
          <div className="flex items-center gap-1.5">
            ...
            <div
              className="hidden sm:block w-20 h-1 bg-muted rounded-full cursor-pointer"
              onClick={(e) => {
                const rect = e.currentTarget.getBoundingClientRect();
